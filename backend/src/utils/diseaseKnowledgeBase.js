// backend/src/utils/diseaseKnowledgeBase.js
// ─────────────────────────────────────────────────────────
// Complete disease knowledge base derived from PlantVillage dataset.
// 38 disease classes across 14 crops.
//
// Each entry: { description, severity, treatments, fertilizers,
//               organic, prevention, affectedParts, spreadMethod }
//
// Used by:
//   1. HuggingFace model label → enrich result
//   2. Fallback rule engine when AI is unavailable
// ─────────────────────────────────────────────────────────
